...
|---------------------------|--------------|------|
| [滴流 Drop Flow 2026（规划中）](./drop-flow-series/drop-flow-2026.md) | 实时引擎 + 空间交互版本（规划中），支持多人协同交互、空间漫游探索 | 2026 |
...
| 版本（可点击，带中英文开头） | 说明（完整正式） | 时间 |
|---------------------------|--------------|------|
| [TIMER 控时者 2026（规划中）](./timer-series/timer-2026.md) | Apple Vision Pro 双目立体空间版本（规划中），空间沉浸演出、可环绕可进入 | 2026 |
| [TIMER 控时者 影像环形沉浸版](./timer-series/timer.md) | UFO Terminal「加载… 权限 2」展览单元 - 环形沉浸屏幕音画互动影像作品 | 2024.11–12 |
...
### 个人作品集关联
本团队作品同时也在核心成员的个人作品集展示：
- 钱誉文个人作品集：[https://github.com/ewanqian/portfolio](https://github.com/ewanqian/portfolio)
